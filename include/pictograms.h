...
//
// I2c/Can/Serial/Settings reproduce the mother's geometry exactly. Vibration and
// Logs are new, drawn in the same language because the Pi has no equivalent
// subsystem. Knife is the splash multi-tool.
//
...
enum class Glyph : uint8_t { None = 0, I2c, Can, Serial, Vibration, Logs, Settings, Knife };
